...
class RRT_Star_Planner:
    ...
    def __init__(self , start:list , goal:list , obstacles,
...
def create_obstacles(start , goal , obstacles_num , map_size):
    """
...
if __name__ == "__main__":
    ...
    num_obstacles = 6
    map_size = [20, 20]
    obstacles = create_obstacles(Node(start[0] ,start[1]) , Node(goal[0], goal[1]), num_obstacles , map_size)
    rrt = RRT_Planner(start, goal, obstacles)
    rrt_star = RRT_Star_Planner(start, goal,obstacles)
    ...
    print("RRT Animation completed and saved.")
