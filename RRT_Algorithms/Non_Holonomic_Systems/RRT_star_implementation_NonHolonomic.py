    ...
    def is_collision_free(self, start_node, end_node, resolution=0.05):
        ...
        for x, y, _ in configurations:
            ...
            for ox, oy, r in self.obstacles:
                if np.linalg.norm((x - ox, y - oy)) <= r + 0.2:
...
if __name__ == "__main__":
    ...
    ani.save("rrt_star_NH_animation5.gif", writer="pillow", fps=30)
    print("Animation completed and saved as 'rrt_star_NH_animation5.gif'")
    print("="*50)